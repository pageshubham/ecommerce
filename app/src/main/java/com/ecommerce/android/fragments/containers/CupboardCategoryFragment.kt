...
import com.ecommerce.android.databinding.FragmentCupboardCategoryBinding
...
class CupboardCategoryFragment : Fragment() {
    ...
    private var _binding: FragmentCupboardCategoryBinding? = null
    private val binding get() = _binding!!

    private val viewModel: RegisterViewModel by viewModels()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = FragmentCupboardCategoryBinding.inflate(inflater, container, false)
        return binding.root
    }
